export const menu = [
  ...
  // },
  // {
  //   href: '/landing-page-20',
  //   title: 'Analytics In E-Book'
  // },
  // {
  //   href: '/landing-page-21',
  //   title: 'Data Analytics News'
  // },
  // {
  //   href: '/landing-page-22',
  //   title: 'Projects Minimal Showcase'
  // }
...
export const pages = [
  ...
  {
    href: '/offices-and-businesses',
    title: 'Office And Businesses'
  },
  {
    href: '/event-management-companies',
    title: 'Event Management Companies'
  },
  {
    href: '/hotels-and-hospitality-businesses',
