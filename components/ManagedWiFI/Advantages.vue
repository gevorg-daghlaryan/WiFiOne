<template>
  <section class="pt-0">
    <div class="container">
      <div class="row">
        <div class="col-lg-4 col-md-6 mb-4" v-for="(list,index) in items" :key="index">
          <CardStyle1>
  ...
  data() {
    return{
      items : [
        ...
        {
          title: 'Latest WiFi standards',
          description: 'Premium 802.11ax WiFi offers 2x bandwidth and lower latency, coupled with maximum WPA3 security.',
          src: require('../../assets/images/home/services/19.png')
        },
        {
        ...
        },
        {
          ...
          description: 'Continuous monitoring of vital equipment to preemptively identify issues, ensuring optimal performance and reducing downtime risks.',
          src: require('../../assets/images/home/services/05.png')
        },
        {
          title: 'Faster 6GHz WiFi 6E support',
          description: 'Option for the latest WiFi 6E support for the highest bandwidth on 6GHz modern devices',
          src: require('../../assets/images/home/services/22.png')
        }
      ]
    }
  }
